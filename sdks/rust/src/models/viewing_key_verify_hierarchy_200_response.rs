...
pub struct ViewingKeyVerifyHierarchy200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ViewingKeyVerifyHierarchy200ResponseData>>,
}

impl ViewingKeyVerifyHierarchy200Response {
    pub fn new() -> ViewingKeyVerifyHierarchy200Response {
