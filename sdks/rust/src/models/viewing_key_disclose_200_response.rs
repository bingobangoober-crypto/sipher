...
pub struct ViewingKeyDisclose200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ViewingKeyDisclose200ResponseData>>,
}

impl ViewingKeyDisclose200Response {
    pub fn new() -> ViewingKeyDisclose200Response {
