...
pub struct SubmitJitoBundle200Response {
    ...
    pub data: Option<Box<models::SubmitJitoBundle200ResponseData>>,
}

impl SubmitJitoBundle200Response {
    pub fn new() -> SubmitJitoBundle200Response {
