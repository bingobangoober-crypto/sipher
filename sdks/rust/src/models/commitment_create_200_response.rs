...
pub struct CommitmentCreate200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::CommitmentCreate200ResponseData>>,
}

impl CommitmentCreate200Response {
    pub fn new() -> CommitmentCreate200Response {
