...
pub struct BackendsSelect200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::BackendsSelect200ResponseData>>,
}

impl BackendsSelect200Response {
    pub fn new() -> BackendsSelect200Response {
