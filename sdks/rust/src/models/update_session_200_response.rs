...
pub struct UpdateSession200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::UpdateSession200ResponseData>>,
}

impl UpdateSession200Response {
    pub fn new() -> UpdateSession200Response {
