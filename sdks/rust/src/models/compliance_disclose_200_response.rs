...
pub struct ComplianceDisclose200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ComplianceDisclose200ResponseData>>,
}

impl ComplianceDisclose200Response {
    pub fn new() -> ComplianceDisclose200Response {
