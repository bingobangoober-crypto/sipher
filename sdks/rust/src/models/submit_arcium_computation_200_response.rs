...
pub struct SubmitArciumComputation200Response {
    ...
    pub data: Option<Box<models::SubmitArciumComputation200ResponseData>>,
}

impl SubmitArciumComputation200Response {
    pub fn new() -> SubmitArciumComputation200Response {
