...
pub struct BackendsHealth200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::BackendsHealth200ResponseData>>,
}

impl BackendsHealth200Response {
    pub fn new() -> BackendsHealth200Response {
