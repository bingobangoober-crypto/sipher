...
pub struct StealthGenerateBatch200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::StealthGenerateBatch200ResponseData>>,
}

impl StealthGenerateBatch200Response {
    pub fn new() -> StealthGenerateBatch200Response {
