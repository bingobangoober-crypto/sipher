...
pub struct ListAdminKeys200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ListAdminKeys200ResponseData>>,
}

impl ListAdminKeys200Response {
    pub fn new() -> ListAdminKeys200Response {
