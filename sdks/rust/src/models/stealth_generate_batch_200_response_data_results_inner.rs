...
pub struct StealthGenerateBatch200ResponseDataResultsInner {
    #[serde(rename = "index", skip_serializing_if = "Option::is_none")]
    pub index: Option<i32>,
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::StealthGenerate200ResponseData>>,
    #[serde(rename = "error", skip_serializing_if = "Option::is_none")]
    pub error: Option<String>,
}

impl StealthGenerateBatch200ResponseDataResultsInner {
    pub fn new() -> StealthGenerateBatch200ResponseDataResultsInner {
