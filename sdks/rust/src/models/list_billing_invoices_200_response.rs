...
pub struct ListBillingInvoices200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ListBillingInvoices200ResponseData>>,
}

impl ListBillingInvoices200Response {
    pub fn new() -> ListBillingInvoices200Response {
