...
pub struct ProofsFundingVerifyRequest {
    #[serde(rename = "type")]
    pub r#type: Type,
    #[serde(rename = "proof")]
    pub proof: String,
...
impl ProofsFundingVerifyRequest {
    pub fn new(r#type: Type, proof: String, public_inputs: Vec<String>) -> ProofsFundingVerifyRequest {
