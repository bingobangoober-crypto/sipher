...
pub struct DecryptArciumResult200Response {
    ...
    pub data: Option<Box<models::DecryptArciumResult200ResponseData>>,
}

impl DecryptArciumResult200Response {
    pub fn new() -> DecryptArciumResult200Response {
