...
pub struct CommitmentCreateBatch200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::CommitmentCreateBatch200ResponseData>>,
}

impl CommitmentCreateBatch200Response {
    pub fn new() -> CommitmentCreateBatch200Response {
