...
pub struct ProofsValidityGenerate200Response {
    ...
    pub data: Option<Box<models::ProofsValidityGenerate200ResponseData>>,
}

impl ProofsValidityGenerate200Response {
    pub fn new() -> ProofsValidityGenerate200Response {
