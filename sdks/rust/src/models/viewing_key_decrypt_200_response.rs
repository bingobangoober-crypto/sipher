...
pub struct ViewingKeyDecrypt200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ViewingKeyDecrypt200ResponseData>>,
}

impl ViewingKeyDecrypt200Response {
    pub fn new() -> ViewingKeyDecrypt200Response {
