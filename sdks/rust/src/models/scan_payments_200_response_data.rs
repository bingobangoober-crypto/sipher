...
pub struct ScanPayments200ResponseData {
    #[serde(rename = "payments", skip_serializing_if = "Option::is_none")]
    pub payments: Option<Vec<models::ScanPayments200ResponseDataPaymentsInner>>,
    #[serde(rename = "scanned", skip_serializing_if = "Option::is_none")]
    pub scanned: Option<i32>,
}

impl ScanPayments200ResponseData {
    pub fn new() -> ScanPayments200ResponseData {
