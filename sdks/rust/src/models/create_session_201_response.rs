...
pub struct CreateSession201Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::CreateSession201ResponseData>>,
}

impl CreateSession201Response {
    pub fn new() -> CreateSession201Response {
