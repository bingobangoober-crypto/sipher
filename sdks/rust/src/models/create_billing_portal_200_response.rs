...
pub struct CreateBillingPortal200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::CreateBillingPortal200ResponseData>>,
}

impl CreateBillingPortal200Response {
    pub fn new() -> CreateBillingPortal200Response {
