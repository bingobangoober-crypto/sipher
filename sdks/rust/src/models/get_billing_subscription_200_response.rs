...
pub struct GetBillingSubscription200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::GetBillingSubscription200ResponseData>>,
}

impl GetBillingSubscription200Response {
    pub fn new() -> GetBillingSubscription200Response {
