...
pub struct CommitmentCreateBatchRequest {
    #[serde(rename = "items")]
    pub items: Vec<models::CommitmentCreateBatchRequestItemsInner>,
}

impl CommitmentCreateBatchRequest {
    pub fn new(items: Vec<models::CommitmentCreateBatchRequestItemsInner>) -> CommitmentCreateBatchRequest {
