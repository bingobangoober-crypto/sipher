...
pub struct ProofsRangeGenerate200Response {
    ...
    pub data: Option<Box<models::ProofsRangeGenerate200ResponseData>>,
}

impl ProofsRangeGenerate200Response {
    pub fn new() -> ProofsRangeGenerate200Response {
