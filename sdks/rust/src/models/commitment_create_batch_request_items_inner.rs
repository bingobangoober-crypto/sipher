...
pub struct CommitmentCreateBatchRequestItemsInner {
    #[serde(rename = "value")]
    pub value: String,
...
impl CommitmentCreateBatchRequestItemsInner {
    pub fn new(value: String) -> CommitmentCreateBatchRequestItemsInner {
