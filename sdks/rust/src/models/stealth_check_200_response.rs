...
pub struct StealthCheck200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::StealthCheck200ResponseData>>,
}

impl StealthCheck200Response {
    pub fn new() -> StealthCheck200Response {
