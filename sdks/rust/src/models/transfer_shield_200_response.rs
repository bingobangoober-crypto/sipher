...
pub struct TransferShield200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::TransferShield200ResponseData>>,
}

impl TransferShield200Response {
    pub fn new() -> TransferShield200Response {
