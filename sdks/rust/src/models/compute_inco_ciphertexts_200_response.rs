...
pub struct ComputeIncoCiphertexts200Response {
    ...
    pub data: Option<Box<models::ComputeIncoCiphertexts200ResponseData>>,
}

impl ComputeIncoCiphertexts200Response {
    pub fn new() -> ComputeIncoCiphertexts200Response {
