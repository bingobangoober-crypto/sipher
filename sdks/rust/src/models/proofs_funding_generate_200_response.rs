...
pub struct ProofsFundingGenerate200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ProofsFundingGenerate200ResponseData>>,
}

impl ProofsFundingGenerate200Response {
    pub fn new() -> ProofsFundingGenerate200Response {
