...
pub struct PrivacyScore200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::PrivacyScore200ResponseData>>,
}

impl PrivacyScore200Response {
    pub fn new() -> PrivacyScore200Response {
