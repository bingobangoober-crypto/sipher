...
pub struct HandleBillingWebhook200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::HandleBillingWebhook200ResponseData>>,
}

impl HandleBillingWebhook200Response {
    pub fn new() -> HandleBillingWebhook200Response {
