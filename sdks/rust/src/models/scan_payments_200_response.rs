...
pub struct ScanPayments200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ScanPayments200ResponseData>>,
}

impl ScanPayments200Response {
    pub fn new() -> ScanPayments200Response {
