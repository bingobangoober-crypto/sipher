...
pub struct EncryptIncoValue200Response {
    ...
    pub data: Option<Box<models::EncryptIncoValue200ResponseData>>,
}

impl EncryptIncoValue200Response {
    pub fn new() -> EncryptIncoValue200Response {
