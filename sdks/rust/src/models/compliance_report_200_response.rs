...
pub struct ComplianceReport200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ComplianceReport200ResponseData>>,
}

impl ComplianceReport200Response {
    pub fn new() -> ComplianceReport200Response {
