...
pub struct GetComplianceReport200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::GetComplianceReport200ResponseData>>,
}

impl GetComplianceReport200Response {
    pub fn new() -> GetComplianceReport200Response {
