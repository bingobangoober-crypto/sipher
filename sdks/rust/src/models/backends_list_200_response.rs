...
pub struct BackendsList200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::BackendsList200ResponseData>>,
}

impl BackendsList200Response {
    pub fn new() -> BackendsList200Response {
