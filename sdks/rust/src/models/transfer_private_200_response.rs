...
pub struct TransferPrivate200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::TransferPrivate200ResponseData>>,
}

impl TransferPrivate200Response {
    pub fn new() -> TransferPrivate200Response {
