...
pub struct GetJitoBundleStatus200Response {
    ...
    pub data: Option<Box<models::GetJitoBundleStatus200ResponseData>>,
}

impl GetJitoBundleStatus200Response {
    pub fn new() -> GetJitoBundleStatus200Response {
