...
pub struct GetBillingUsage200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::GetBillingUsage200ResponseData>>,
}

impl GetBillingUsage200Response {
    pub fn new() -> GetBillingUsage200Response {
