...
pub struct ListAdminTiers200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ListAdminTiers200ResponseData>>,
}

impl ListAdminTiers200Response {
    pub fn new() -> ListAdminTiers200Response {
