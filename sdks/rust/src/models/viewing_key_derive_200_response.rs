...
pub struct ViewingKeyDerive200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ViewingKeyDerive200ResponseData>>,
}

impl ViewingKeyDerive200Response {
    pub fn new() -> ViewingKeyDerive200Response {
