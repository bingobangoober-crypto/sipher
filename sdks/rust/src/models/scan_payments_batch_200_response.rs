...
pub struct ScanPaymentsBatch200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::ScanPaymentsBatch200ResponseData>>,
}

impl ScanPaymentsBatch200Response {
    pub fn new() -> ScanPaymentsBatch200Response {
