...
pub struct ProofsFulfillmentVerifyRequest {
    #[serde(rename = "type")]
    pub r#type: Type,
    #[serde(rename = "proof")]
    pub proof: String,
...
impl ProofsFulfillmentVerifyRequest {
    pub fn new(r#type: Type, proof: String, public_inputs: Vec<String>) -> ProofsFulfillmentVerifyRequest {
