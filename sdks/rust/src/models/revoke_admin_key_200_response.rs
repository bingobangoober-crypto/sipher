...
pub struct RevokeAdminKey200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<models::RevokeAdminKey200ResponseData>>,
}

impl RevokeAdminKey200Response {
    pub fn new() -> RevokeAdminKey200Response {
