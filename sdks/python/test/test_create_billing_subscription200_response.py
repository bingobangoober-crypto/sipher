...
class TestCreateBillingSubscription200Response(unittest.TestCase):
    """CreateBillingSubscription200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateBillingSubscription200Response:
        """Test CreateBillingSubscription200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateBillingSubscription200Response`
        """
        model = CreateBillingSubscription200Response()
        if include_optional:
    ...
    def testCreateBillingSubscription200Response(self):
        """Test CreateBillingSubscription200Response"""
