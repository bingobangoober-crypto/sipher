...
class TestCreateSession201Response(unittest.TestCase):
    """CreateSession201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSession201Response:
        """Test CreateSession201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSession201Response`
        """
        model = CreateSession201Response()
        if include_optional:
    ...
    def testCreateSession201Response(self):
        """Test CreateSession201Response"""
