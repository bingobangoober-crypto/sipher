...
class TestTallyVotes200ResponseData(unittest.TestCase):
    """TallyVotes200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TallyVotes200ResponseData:
        """Test TallyVotes200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TallyVotes200ResponseData`
        """
        model = TallyVotes200ResponseData()
        if include_optional:
            return TallyVotes200ResponseData(
    ...
    def testTallyVotes200ResponseData(self):
        """Test TallyVotes200ResponseData"""
