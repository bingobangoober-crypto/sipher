...
class GetTally200Response(BaseModel):
    """
    GetTally200Response
    """ # noqa: E501
    ...
    data: Optional[GetTally200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetTally200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
