...
class CreateAdminKey201ResponseData(BaseModel):
    """
    CreateAdminKey201ResponseData
    """ # noqa: E501
    id: Optional[StrictStr] = None
    key: Optional[StrictStr] = Field(default=None, description="Raw API key — shown only once")
    ...
    __properties: ClassVar[List[str]] = ["id", "key", "tier", "name", "createdAt", "expiresAt", "limits", "notice"]
