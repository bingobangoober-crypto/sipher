...
class HandleBillingWebhookRequest(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['invoice.paid', 'invoice.payment_failed', 'customer.subscription.updated', 'customer.subscription.deleted']):
            raise ValueError("must be one of enum values ('invoice.paid', 'invoice.payment_failed', 'customer.subscription.updated', 'customer.subscription.deleted')")
        return value
