...
class GetAdminKey200ResponseData(BaseModel):
    """
    GetAdminKey200ResponseData
    """ # noqa: E501
    id: Optional[StrictStr] = None
    key: Optional[StrictStr] = Field(default=None, description="Masked key (first 12 + last 4 chars)")
    ...
    __properties: ClassVar[List[str]] = ["id", "key", "tier", "name", "createdAt", "expiresAt", "revokedAt", "limits", "usage"]
