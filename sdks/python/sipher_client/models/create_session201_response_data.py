...
class CreateSession201ResponseData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["sessionId", "defaults", "createdAt", "expiresAt"]
    ...
    def session_id_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^sess_[0-9a-f]{64}$", value):
            raise ValueError(r"must validate the regular expression /^sess_[0-9a-f]{64}$/")
        return value
