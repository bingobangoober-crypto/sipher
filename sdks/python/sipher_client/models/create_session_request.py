...
class CreateSessionRequest(BaseModel):
    ...
    ttl_seconds: Optional[Annotated[int, Field(le=86400, strict=True, ge=60)]] = Field(default=None, description="Session TTL in seconds (default: 3600, max: 86400)", alias="ttlSeconds")
    __properties: ClassVar[List[str]] = ["defaults", "ttlSeconds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "defaults": CreateSessionRequestDefaults.from_dict(obj["defaults"]) if obj.get("defaults") is not None else None,
