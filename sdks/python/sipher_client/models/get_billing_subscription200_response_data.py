...
class GetBillingSubscription200ResponseData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "plan", "status", "currentPeriodStart", "currentPeriodEnd"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['active', 'past_due', 'canceled']):
            raise ValueError("must be one of enum values ('active', 'past_due', 'canceled')")
        return value
