...
class GetJitoBundleStatus200ResponseData(BaseModel):
    """
    ...
    confirmed_at: Optional[StrictInt] = Field(default=None, description="Present when status is confirmed", alias="confirmedAt")
    __properties: ClassVar[List[str]] = ["bundleId", "status", "progress", "slot", "signature", "confirmedAt"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['submitted', 'bundled', 'confirming', 'confirmed']):
            raise ValueError("must be one of enum values ('submitted', 'bundled', 'confirming', 'confirmed')")
        return value
