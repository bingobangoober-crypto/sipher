...
class SubmitBallot200ResponseData(BaseModel):
    """
    SubmitBallot200ResponseData
    """ # noqa: E501
    proposal_id: Optional[StrictStr] = Field(default=None, alias="proposalId")
    nullifier: Optional[StrictStr] = None
    accepted: Optional[StrictBool] = None
    total_ballots: Optional[StrictInt] = Field(default=None, alias="totalBallots")
    __properties: ClassVar[List[str]] = ["proposalId", "nullifier", "accepted", "totalBallots"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "totalBallots": obj.get("totalBallots")
        })
        return _obj
