...
class GetSession200ResponseData(BaseModel):
    """
    ...
    last_accessed_at: Optional[StrictInt] = Field(default=None, alias="lastAccessedAt")
    __properties: ClassVar[List[str]] = ["sessionId", "defaults", "createdAt", "expiresAt", "lastAccessedAt"]
