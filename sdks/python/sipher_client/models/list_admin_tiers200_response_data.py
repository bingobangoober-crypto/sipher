...
class ListAdminTiers200ResponseData(BaseModel):
    """
    ListAdminTiers200ResponseData
    """ # noqa: E501
    tiers: Optional[List[ListAdminTiers200ResponseDataTiersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tiers": [ListAdminTiers200ResponseDataTiersInner.from_dict(_item) for _item in obj["tiers"]] if obj.get("tiers") is not None else None
        })
        return _obj
