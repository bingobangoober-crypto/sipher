...
class TallyVotes200Response(BaseModel):
    """
    TallyVotes200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    beta: Optional[StrictBool] = None
    data: Optional[TallyVotes200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "beta": obj.get("beta"),
            "data": TallyVotes200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
