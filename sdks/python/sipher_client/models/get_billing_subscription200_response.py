...
class GetBillingSubscription200Response(BaseModel):
    """
    GetBillingSubscription200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[GetBillingSubscription200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GetBillingSubscription200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
