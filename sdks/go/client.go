...
// APIClient manages communication with the Sipher — Privacy-as-a-Skill API API v0.1.0
...
type APIClient struct {
	...
	ViewingKeyAPI *ViewingKeyAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ViewingKeyAPI = (*ViewingKeyAPIService)(&c.common)
