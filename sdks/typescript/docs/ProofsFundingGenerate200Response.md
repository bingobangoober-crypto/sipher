...
```typescript
import type { ProofsFundingGenerate200Response } from '@sip-protocol/sipher-client'
...
const exampleParsed = JSON.parse(exampleJSON) as ProofsFundingGenerate200Response
