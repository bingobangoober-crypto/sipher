...
```typescript
import type { StealthMetaAddress } from '@sip-protocol/sipher-client'
...
const exampleParsed = JSON.parse(exampleJSON) as StealthMetaAddress
